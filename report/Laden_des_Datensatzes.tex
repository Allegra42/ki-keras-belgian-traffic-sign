...
\begin{figure} [!ht]
	\centering
	\subfloat[Klasse 2 \label{pic:2}]{\includegraphics[scale=0.25]{2}}
	\subfloat[Klasse 27 \label{pic:27}]{\includegraphics[scale=0.53]{27}}
	\subfloat[Klasse 28 \label{pic:28}]{\includegraphics[scale=1.0]{28}}\\
	\subfloat[Klasse 30 \label{pic:30}]{\includegraphics[scale=0.99]{30}}
	\subfloat[Klasse 41 \label{pic:41}]{\includegraphics[scale=0.4]{41}}
	\subfloat[Klasse 56 \label{pic:56}]{\includegraphics[scale=0.5]{56}}
